...
import GoldenTemple from '../TourCard-Details/GoldenTemple';
...
const TourCard2 = () => {
  return (
    <div className=''>
        <div className='  '>
           <div className=' w-[310px]  border-2 border-grey-300 shadow-lg border-1  rounded-xl'> 
              <img className='w-[310px] h-[230px] object-fill rounded-tl-lg rounded-tr-lg' src={photo1} alt="" />
              ...
              <div className='flex'>
               ...
               <div className='flex'>
                  <button className='mt-10 mb-2 ml-6 rounded-3xl px-4 py-2  bg-[#e38e3d] text-white'><Link to="/GoldenTemple" >Learn More</Link></button>
